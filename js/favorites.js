...
export class Favorites {
  ...
  load() {
    this.entries = JSON.parse(
      localStorage.getItem('@git-favorites:')
    ) || []
  }
...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    tr.innerHTML = `<th class="user">
      <img src="https://github.com/davidapollo11.png" alt="Imagem de David Apollo">
      <a href="https://github.com/davidapollo11" target="_blank">
        <p>David Apollo</p>
        <span>/davidapollo11</span>
      </a>
      </th>
      <th class="repositories">4</th>
      <th class="followers">8</th>
      <th class="action">
  ...
  generateEmpty() {
    const generator = this.createEmpty()
    this.root.append(generator)
  ...
  createEmpty() {
    ...
    div.innerHTML = `<svg width="132" height="125" viewBox="0 0 57 54" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  validatorEmpty() {
    const div = this.root.querySelector('.empty')
